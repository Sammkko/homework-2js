...
swapEl.onclick = () =>{
    currencyOneEl.innerHTML= renderRatesEUR;
    currencyTwoEl.innerHTML= renderRatesUSD;
}
...
const getData= () =>{
    ...
    .then((data) =>{
        ...
        calculate(currencyData, currencyTwo);
    });
};

const runCalculate = () => {
    calculate(currencyData, currencyTwoEl.value);
}
